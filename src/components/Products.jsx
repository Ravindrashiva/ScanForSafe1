...
const PRODUCTS = [
  {
    ...
    icon: Car,
    image: carimg,
    title: "Car Protection Decal",
    subtitle: "Best Smart Parking Sticker for Cars",
    desc: "Weatherproof smart parking QR code for cars. Enables instant vehicle owner alert QR sticker notifications for wrong parking or emergencies without exposing your phone number.",
    features: [
  ...
  },
  {
    ...
    icon: Bike,
    image: bike1img,
    title: "Bike Security Decal",
    subtitle: "Best QR Code Sticker for Bikes",
    desc: "Anti-theft vehicle QR code and smart QR tag for motorcycle and bike security. Features dynamic owner alerts, instant scanner contact, and GPS bike recovery support.",
    features: [
  ...
  },
  {
    ...
    subtitle: "Best QR Pet Tags for Dogs & Cats",
    desc: "Waterproof QR pet ID tag for dog and cat collars. Integrates smart dog collar tag with GPS alerts, lost pet recovery systems, and NFC contact capability.",
    features: [
  ...
  },
  {
    ...
    icon: Package,
    image: luggageimg,
    title: "Luggage Guard Tag",
    subtitle: "Best QR Luggage Tags for International Travel",
    desc: "Strong adhesive QR luggage tags for bags, laptop security, and keys. Leverages smart NFC stickers for top luggage safety and lost item recovery.",
    features: [
  ...
  },
  {
    ...
    icon: UserRound,
    image: seniorimg,
    title: "Senior Safety Band",
    subtitle: "Best Senior Citizen SOS Bands",
    desc: "Emergency contact QR band and senior citizen medical ID wristband. Provides secure medical alert details, contact routing, and auto-escalating family notifications.",
    features: [
  ...
  },
  {
    ...
    icon: Baby,
    image: kidimg,
    title: "Child Safety Patch",
    subtitle: "Best Child Safety ID Wristbands",
    desc: "Kids safety QR patch and emergency contact QR wristbands. Quick scan protection for kids, child safety QR code tags, and real-time parents alerts.",
    features: [
